...
export const copyEn = {
  ...
  duringVisit: {
    ...
    subtitle:
      'Visiting hours are from 10:00 AM to 8:00 PM. Free shuttle services are available around the clock from several areas across Damascus.',
    discoverSchools: {
      time: '10:00 AM',
    ...
    doorsClose: {
      ...
      title: 'Doors Close',
      location: 'All Zones',
      desc: 'The expo is open daily from 10:00 AM to 8:00 PM.',
    },
  },
  campusSpotlight: {
  ...
  faq: {
    ...
    q4: { q: 'What are the visiting hours?', a: 'Visiting hours are from 10:00 AM to 8:00 PM.' },
    q5: {
      q: 'Is there transportation to the Fairground (Fair City)?',
      a: 'Yes, free shuttle services are available around the clock from several areas across Damascus.',
    },
  },
  registration: {
